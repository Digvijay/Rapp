...
app.MapGrpcService<Rapp.Samples.GrpcService.RappDataService>();
...
namespace Rapp.Samples.GrpcService
{
    ...
    public class RappDataService : DataService.DataServiceBase
    {
        ...
        public RappDataService(HybridCache cache, ILogger<RappDataService> logger)
        {
            _cache = cache;
            _logger = logger;
        }
        ...
        private static async Task<CachedData> FetchDataFromDatabase(int id, CancellationToken ct)
        {
        ...
        private static async Task<CachedDataList> FetchDataListFromDatabase(int page, int pageSize, CancellationToken ct)
        {
            // Simulate database fetch
